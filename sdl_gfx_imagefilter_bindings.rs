...
extern "C" {
  pub fn SDL_imageFilterAdd(
    Src1: *mut libc::c_uchar, Src2: *mut libc::c_uchar, Dest: *mut libc::c_uchar,
    length: libc::c_uint,
  ) -> libc::c_int;
}
extern "C" {
...
extern "C" {
  pub fn SDL_imageFilterBitNegation(
    Src1: *mut libc::c_uchar, Dest: *mut libc::c_uchar, length: libc::c_uint,
  ) -> libc::c_int;
}
extern "C" {
  pub fn SDL_imageFilterAddByte(
    Src1: *mut libc::c_uchar, Dest: *mut libc::c_uchar, length: libc::c_uint, C: libc::c_uchar,
  ) -> libc::c_int;
}
extern "C" {
  pub fn SDL_imageFilterAddUint(
    Src1: *mut libc::c_uchar, Dest: *mut libc::c_uchar, length: libc::c_uint, C: libc::c_uint,
  ) -> libc::c_int;
}
extern "C" {
...
extern "C" {
  pub fn SDL_imageFilterShiftRight(
    Src1: *mut libc::c_uchar, Dest: *mut libc::c_uchar, length: libc::c_uint, N: libc::c_uchar,
  ) -> libc::c_int;
}
extern "C" {
...
extern "C" {
  pub fn SDL_imageFilterBinarizeUsingThreshold(
    Src1: *mut libc::c_uchar, Dest: *mut libc::c_uchar, length: libc::c_uint, T: libc::c_uchar,
  ) -> libc::c_int;
}
extern "C" {
  pub fn SDL_imageFilterClipToRange(
    Src1: *mut libc::c_uchar, Dest: *mut libc::c_uchar, length: libc::c_uint, Tmin: libc::c_uchar,
    Tmax: libc::c_uchar,
  ) -> libc::c_int;
}
extern "C" {
  pub fn SDL_imageFilterNormalizeLinear(
    Src: *mut libc::c_uchar, Dest: *mut libc::c_uchar, length: libc::c_uint, Cmin: libc::c_int,
    Cmax: libc::c_int, Nmin: libc::c_int, Nmax: libc::c_int,
  ) -> libc::c_int;
}
