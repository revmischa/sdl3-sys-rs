...
extern "C" {
  pub fn IMG_LoadTyped_RW(
    src: *mut SDL_RWops, freesrc: libc::c_int, type_: *const libc::c_char,
  ) -> *mut SDL_Surface;
}
extern "C" {
...
extern "C" {
  pub fn IMG_LoadTexture(
    renderer: *mut SDL_Renderer, file: *const libc::c_char,
  ) -> *mut SDL_Texture;
}
extern "C" {
  pub fn IMG_LoadTexture_RW(
    renderer: *mut SDL_Renderer, src: *mut SDL_RWops, freesrc: libc::c_int,
  ) -> *mut SDL_Texture;
}
extern "C" {
...
extern "C" {
  pub fn IMG_SaveJPG(
    surface: *mut SDL_Surface, file: *const libc::c_char, quality: libc::c_int,
  ) -> libc::c_int;
}
extern "C" {
  pub fn IMG_SaveJPG_RW(
    surface: *mut SDL_Surface, dst: *mut SDL_RWops, freedst: libc::c_int, quality: libc::c_int,
  ) -> libc::c_int;
}
